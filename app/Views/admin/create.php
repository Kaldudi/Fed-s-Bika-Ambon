...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h1 class="text-3xl font-bold text-brand-dark mb-6">Tambah Menu Bika Ambon</h1>

        <form action="/admin/store" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?= csrf_field() ?>
            <div>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" required 
                          class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-teal"></textarea>
            </div>
            ...
            <div class="flex justify-end gap-4 pt-4 border-t border-gray-100">
                ...
                <button type="submit" class="bg-brand-teal text-white px-6 py-2 rounded-lg font-bold hover:bg-teal-700 transition-colors">
                    Simpan
                </button>
            </div>
        </form>
